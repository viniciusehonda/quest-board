...
{
    /// <inheritdoc />
    public partial class AddUserQuest : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Password_PasswordHash = table.Column<string>(type: "TEXT", nullable: true),
                    Password_PasswordSalt = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
